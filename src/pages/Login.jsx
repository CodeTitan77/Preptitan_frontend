    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-zinc-900/70 backdrop-blur-xl border border-zinc-800/80 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-zinc-500 text-sm text-center mb-8">Sign in to continue</p>
          ...
          <p className="text-zinc-600 text-xs text-center mt-6">
            ...
            <button onClick={()=>navigate('/register')}className="text-indigo-400 cursor-pointer hover:text-indigo-300 transition font-medium">Create one</button>
          </p>
        </div>
